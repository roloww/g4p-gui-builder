...
public class TestDemo extends JFrame{
	...
	public void initWords(){
		String w = "abstract continue for new switch assert default goto package ";
		w += "synchronized boolean do if private this break double implements ";
		w += "protected throw byte else import public throws case enum instanceof ";
		w += "return transient catch extends int short try char final interface static";
		w += " void class finally long strictfp volatile const float native super while";
		String[] ws = w.split(" ");
		for(String s : ws)
			words.add(s);
	}
